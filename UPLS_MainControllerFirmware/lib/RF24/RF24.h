...
{
private:
	DigitalOut _ce; /**< "Chip Enable" pin, activates the RX or TX role */
	DigitalOut _csn; /**< SPI Chip select */
	SPI        _SPI;
    Timer      _t;
...
public:
	 ...
	 */
	RF24(PinName mosi, PinName miso, PinName sck, PinName csn, PinName ce);
